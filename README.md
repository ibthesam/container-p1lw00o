...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-p1lw00o.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-p1lw00o.containers.anotherwebservice.com/
...
```
git clone git@github.com:ibthesam/container-p1lw00o.git
cd container-p1lw00o
```
...
```
docker attach container-p1lw00o
```
